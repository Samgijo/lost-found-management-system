...
├── README.md                     # This file
└── README_DB.md                  # Database inspection guide
```
...
Several helper classes are provided in `src/` and `archived_helpers/`:

| Tool | Purpose |
|------|---------|
| `DbInspector.java` | Print table structure |
| `UiInspector.java` | Inspect UI components |
| `InspectMySQLListings.java` | Inspect MySQL listings table |
| `ClearMySQLListings.java` | Clear all MySQL listings |
| `ClearVerifiedReports.java` | Clear verified reports table |
| `AlterListingsAddContact.java` | Add contact_info column to listings |
| `AlterVerifiedReportsAddContact.java` | Add contact_info column to verified_reports |
| `CopyListingContactToVerifiedContact.java` | Sync contact info between tables |
| `CopyReporterEmailToVerifiedContact.java` | Sync reporter emails |
